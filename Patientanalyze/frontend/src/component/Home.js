...
class Home extends Component {
    ...
    render(){
        ...
        return(
         ...
         <div className="text-white ml-4 mt-5 col-lg-7 leftfont">Data-driven services for hosiptals with end-to-end data protection and accountability. 
         <br></br><br></br><p className="button-text"> <Link to="/see1" className="text-white p-2 pl-5 pr-5 mt-1 buttonmargin btn-see">SEE HOW IT WORKS</Link></p></div>
