# Ideas
  # Idea: Statistical Analysis of Hospital Data using MPC
  ...
  ##### Proposed Methodology
   ...
   For predictive analysis we will use Machine Learning algorithms.
    
  # Idea: Secure Course Guider using MPC
